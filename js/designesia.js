    ...
    'use strict';
     ...
     function load_owl() {
        jQuery("#items-carousel").owlCarousel({
         ...
         jQuery("#items-carousel-luxury").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            margin:25,
         ...
         jQuery("#items-carousel-brands").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            autoplay:true,
         ...
         jQuery("#items-carousel-hero").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            autoplay:true,
         ...
         jQuery("#items-carousel-SUVs").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            autoplay:true,
         ...
         jQuery("#items-carousel-sedans").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            autoplay:true,
         ...
         jQuery("#items-carousel-sport-car").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            autoplay:true,
     ...
     function load_owl_1() {
        jQuery("#items-carousel-1").owlCarousel({
            center: false,
            items:3,
            rewind:true,
            margin:25,
     ...
     jQuery(document).ready(function() {
        ...
        $(window).scroll(function () {
            ...
            if (window.scrollY > 70) { // Change 100 to the desired scroll position
                    $('.navbar_item').addClass('text-black')
                    $('.navbar_item').removeClass('text-white')
            } else {
                $('.navbar_item').addClass('text-white')
                $('.navbar_item').removeClass('text-black')
